<?php
    ...
    require("../class/Omisiones.php"); // Tiene la clase conexion para conectar a la ga base de datos
    require("../class/Areas.php"); // Tiene la clase conexion para conectar a la ga base de datos
?>