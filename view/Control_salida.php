...
<form action="../request/Controles.php" method="post" class="form">
    <header class="p20 uper-bold">
        Registro de control - Salida
        <div class="container-camps p10">
            <div class="select-w-btn">
                <label for="" class="w-t bg-black-blue">Hora de salida</label>
                <input type="time" name="salida" id="" class="campo" value="<?= date('H:i') ?>" >
            </div>
        </div>
    </header>
    ...
    <div class="container-camps">
        <button type="submit" class="btn bg-black-blue" name="id_salida" value="<?= $_POST['salida']?>">Registrar</button>
    </div>
</form>
<script>
