...
<a href="Omisiones_pdf_filtro.php" class="pdf" target="_blank">
    ...
    <form action="" method="post">
        <div class="filtros">
            <label for="date-f" class="date-filter">
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="#fff" class="bi bi-calendar-week" viewBox="0 0 16 16">
